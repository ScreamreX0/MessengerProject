...
public class DialogsFragment extends Fragment implements ConversationsHelper.IConversationsFragment{
    // Firebase
    ...
    public void init(View view) {
        ...
        conversationsRecycleView = view.findViewById(R.id.f_dialogs_recycle_view);
    ...
    public void displayConversations() {
        new ConversationsHelper(getContext(),
                ...
                ConversationsHelper.ConversationType.dialog).displayConversations();
    }
}